<div id="bsModal" class="modal fade modal_repo" data-bs-focus="false" style="height: auto;">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg-default">
                <h5 class="modal-title w-100 text-center" id="bsTitle"></h5>
                    ...
                    <div class="left-side col">
                        ...
                        <form id="form_reset">
                            <div class="row mb-3">
                                <div class="col-6">
                                    <div class="f-outline">
                                        <input class="forminput form-control requiredField bg-white text-uppercase form_disable" type="search" id="billing_statement" name="billing_statement" placeholder=" ">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <div class="f-outline">
                                        ...
                                        <label for="client_name" class="formlabel form-label">BILLED TO</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">
