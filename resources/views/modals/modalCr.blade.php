<div id="crModal" class="modal fade modal_repo" data-bs-focus="false" style="height: auto;">
                    ...
                    <div class="left-side col">
                        ...
                        <form id="form_reset">
                            <div class="row mb-3">
                                <div class="col-6">
                                    <div class="f-outline">
                                        <input class="forminput form-control requiredField bg-white text-uppercase form_disable" type="search" id="collection_receipt" name="collection_receipt" placeholder=" ">
                            ...
                            <div class="row mb-3" id="uploaded_by_div" style="display:none;">
                                <div class="col">
                                    <div class="f-outline">
                                        <input class="forminput form-control requiredField bg-white text-uppercase form_disable" type="search" id="uploaded_by" name="uploaded_by" placeholder=" ">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <div class="f-outline">
                                        ...
                                        <label for="sales_order" class="formlabel form-label">SALES ORDER NO. <span style="font-size: 13px !important;">(OPTIONAL)</span> </label>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col">
                                    <div class="f-outline">
                                        <input class="forminput form-control bg-white spChar text-uppercase form_disable" type="search" id="sales_invoice" name="sales_invoice" placeholder=" ">
                                        <label for="sales_invoice" class="formlabel form-label">SALES INVOICE NO. <span style="font-size: 13px !important;">(OPTIONAL)</label>
                                    </div>
                                </div>
                            </div>
