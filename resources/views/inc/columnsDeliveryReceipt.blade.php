<div style="width: 210px;">
    <div class="row">
        <div class="col">
            <div class="checkbox">
                <label>
                    <input checked type="checkbox" class="checkboxFilter" id="filter-0" data-column="0" disabled/> DELIVERY RECEIPT NO.
                </label>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col">
            <div class="checkbox">
                <label>
                    <input checked type="checkbox" class="checkboxFilter" id="filter-8" data-column="8" disabled/> PDF FILE
                </label>
            </div>
        </div>
    </div>
