<div style="width: 210px;">
    <div class="row">
        <div class="col">
            <div class="checkbox">
                <label>
                    <input checked type="checkbox" class="checkboxFilter" id="filter-0" data-column="0" disabled/> BILLING STATEMENT NO.
                </label>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col">
            <div class="checkbox">
                <label>
                    <input checked type="checkbox" class="checkboxFilter" id="filter-2" data-column="2" disabled/> BILLED TO
                </label>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col">
            <div class="checkbox">
                <label>
                    <input checked type="checkbox" class="checkboxFilter" id="filter-7" data-column="7"/> PURCHASE ORDER NO.
                </label>
            </div>
        </div>
    </div>
